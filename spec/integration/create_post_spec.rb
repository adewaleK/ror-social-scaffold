...
RSpec.describe 'Post, Comment and Like management', type: :feature do
  let(:user) { User.create!(name: 'Idris', email: 'id@gmail.com', password: 'abc123456789') }
  let(:friend) { User.create!(name: 'James', email: 'ola@gmail.com', password: 'abc123456789') }
  ...
  scenario 'create posts' do
    ...
    fill_in('user[email]', with: 'id@gmail.com')
